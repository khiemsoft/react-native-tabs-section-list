...
var SectionList = /** @class */ (function (_super) {
  ...
  SectionList.prototype.render = function () {
    ...
    var _a = this.props,
      ...
      renderTab = _a.renderTab,
      tabBarStyle = _a.tabBarStyle,
      scrollToLocationOffset = _a.scrollToLocationOffset,
      onSnapToSection = _a.onSnapToSection
    var prepareSections = sections.map(function (item, index) {
      return __assign({}, item, { index: index })
    })
    return (
      <react_native_1.View style={{ flex: 1 }}>
          ...
          onPress={function (index) {
            ...
            if (sectionList && sectionList.scrollToLocation) {
              sectionList.scrollToLocation({
                animated: true,
                itemIndex: 0,
                viewOffset: (scrollToLocationOffset || 0) + height(2),
                sectionIndex: index
              })
            }
          }}
        ...
        <react_native_1.SectionList
          ...
          onMomentumScrollEnd={function () {
            return (_this.blockUpdateIndex = false)
          }}
        />
      </react_native_1.View>
    )
